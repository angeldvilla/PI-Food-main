...
// Obtenemos el parámetro "id" de la URL
  ...
  const [areDietsExpanded, setAreDietsExpanded] = useState(false);

  const toggleDiets = () => {
    setAreDietsExpanded(!areDietsExpanded);
  };
       ...
       {!loading  && <Loader />}
        ...
        <div>
          ...
          <div className={style.healthDietsContainer}>
            ...
            <div className={style.dietsContainer} style={{ maxHeight: areDietsExpanded ? "100%" : "0" }}>
